  ...
  return (
    <motion.div
      ...
      className={`relative shrink-0 flex flex-col ${
        round
          ...
          : "items-start justify-between bg-[#00F0FF] border border-[#222] rounded-[12px]"
    ...
    >
      ...
      <div className="p-5 font-spaceG">
        ...
        {item.degree && (
          <h3 className="text-2xl text-black">Degree: {item.degree}</h3>
        )}
        {item.start && item.end && (
          <h4 className="text-x1 text-black">
            {item.start} - {item.end}
          </h4>
        )}
